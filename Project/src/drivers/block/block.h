...
typedef struct disk_s {
	unsigned      new_disk;    /* Used by certain machines to detect disk change */
	unsigned      dsk_333_bps; /* 33.333 Bits Per Second (BPS) */
	unsigned      dsk_250_bps; /*  250   Bits Per Second (BPS) */
	unsigned      dsk_300_bps; /*  300   Bits Per Second (BPS) */
	unsigned      dsk_500_bps; /*  500   Bits Per Second (BPS) */
	unsigned      dsk_bps;
	unsigned      dsk_160_kb_acorn;
	unsigned      dsk_160_kb_coleco_adam;
	unsigned      dsk_180_kb_atari;
	unsigned      dsk_400_kb_apple_ii;
	unsigned      dsk_500_kb_ibmpc;
	unsigned      dsk_640_kb_ibmpc;
	unsigned      dsk_800_kb_commodore;
	unsigned      dsk_851_kb_apple_lisa;
	unsigned      dsk_1440_kb_apple_ii;
	unsigned      apple_ii_variable_sectors_per_track;
	unsigned      apple_lisa_variable_sectors_per_track;
	unsigned      commodore_variable_sectors_per_track;
	unsigned      type;
	...
	unsigned      drive;
	uint32_t      blocks;        /* Number of tracks currently in use  */
	unsigned long track_half;    /* Required for write precompensation */
	unsigned      write_precomp; /* Required for write precompensation */
	uint32_t      c;
	uint32_t      h;
	uint32_t      s;
	uint32_t      visible_c;

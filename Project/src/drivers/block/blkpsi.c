...
/* unsigned dsk_psi_write_test(disk_psi_t *fdc)
{
unsigned char write_protect;
/* NOTE: This is used by certain floppy disk controller types to determine if a disk is write-protected. */
/* 	if (fdc->dsk.readonly) {
write_protect = 1; /* Disk is     write-protected */
/* 	}
else {
write_protect = 0; /* Disk is not write-protected */
/* 	}
} */

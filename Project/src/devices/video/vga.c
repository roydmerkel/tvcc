...
/* ---------------------------------------------------------------------------------------------------------------- */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Display Support:                            */
/* ---------------------------------------------------------------------------------------------------------------- */
/* The video subsystem supports a 31.5 kHz analog color display or 31.5 kHz analog monochrome display. The system   */
/* sense the type of display and matches the initialization to it. The polarity of the vertical synchronization     */
/* signal to the display determines the number of hori-zontal scans, either 400 or 480. The number of scan lines in */
/* relation to the polarity is:                                                                                     */
/* Scan Lines: Vertical Sync: Horizontal Sync:                                                                      */
/*  - 480:      - Negative:    - Negative:                                                                          */
/*  - 400:      - Positive:    - Negative:                                                                          */
/* If the system senses the presence of a monochrome display, it sums the colors and outputs the video signal to pin*/
/* 4 (green) of the video connector on the system board.                                                            */
/* ---------------------------------------------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Refrence"; Video Registers:                         */
/* ------------------------------------------------------------------------------------------------------------ */
/* The video memory controller gate array responds to I/O addresses 3D4 and 3D5. The video formatter gate array */
/* responds to I/O addresses 3D8 through 3DF.                                                                   */
/*                                                                                                              */
/* The color palette is programmed through the video formatter at addresses 3C6 through 3C9. All registers are  */
/* readable.                                                                                                    */
/*                                                                                                              */
/*The following pages describe the memory controller registers, the video formatter registers, the color palette*/
/* registers, and the char-acter generator. Sample programs of a font load and palette load are also included.  */
/* ------------------------------------------------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Video Memory Controller Registers:      */
/* ------------------------------------------------------------------------------------------------------------ */
...
/*  - 20:        - Reserved                                                                                     */
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_HT        0		/* 00 */ /* Horizontal Total */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Horizontal Total Register, Index 00:    */
/* ------------------------------------------------------------------------------------------------------------ */
/* This register contains the total number of characters in the horizontal scan interval. The number consists   */
/*of both displayed and nondisplayed characters. This register determines the frequency of the 'horizontal sync'*/
/* signal.                                                                                                      */
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_HD        1		/* 01 */ /* Horizontal Characters Displayed */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Horizontal Characters Displayed         */
/* Register, Index 01:                                                                                          */
/* ------------------------------------------------------------------------------------------------------------ */
/* This register determines the total number of characters to be displayed during the horizontal video scan     */
/* interval. This register is loaded with a value of hex 27. The hardware calculates the correct value based on */
/* mode selected.                                                                                               */
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_HBS       2		/* 02 */ /* start horizontal blanking */ /* Start Horizontal Sync (MCGA) */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference";Start Horizontal Sync Register, Index 02:*/
/* ------------------------------------------------------------------------------------------------------------ */
/* This register specifies the character position count at which the 'horizontal sync' signal becomes active.   */
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_HBE       3		/* 03 */ /* end horizontal blanking */ /* Sync Pulse Width (MCGA) */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Sync Pulse Width Register, Index 03:    */
/* ------------------------------------------------------------------------------------------------------------ */
/* This register specifies the pulse widths of the horizontal and vertical synchronization signals. The         */
/* horizontal pulse width is programmed in units of character clocks. The vertical pulse is programmed in units */
/* of the hori-zontal synchronization period. This register is programmed to match the display specifications.  */
/* ------------------------------------------------------------------------------------------------------------ */
/* Bit: Function:                                                                                               */
/*  - 7: - Width VSync3                                                                                         */
/*  - 6: -       VSync2                                                                                         */
...
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_HRS       4		/* 04 */ /* start horizontal retrace pulse */ /* Vertical Total (MCGA) */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Vertical Total Register, Index 04:      */
/* ------------------------------------------------------------------------------------------------------------ */
/* This register contains the 8 least significant bits for the total number of scan lines in the vertical scan  */
/* interval. The most significant bit is the inversion of bit 6 of the Mode Control register. The total number  */
/* consists of both the displayed and nondisplayed scan lines. This register and the Vertical Total Adjust      */
/* register determine the frequency the 'vertical sync' signal.                                                 */
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_HRE       5		/* 05 */ /* end horizontal retrace pulse */ /* Vertical Total Adjust (MCGA) */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference";Vertical Total Adjust Register, Index 05:*/
/* ------------------------------------------------------------------------------------------------------------ */
/* This register is used to adjust the total number of horizontal scan lines in the  vertical synchronization   */
/* scan-ning interval. It allows for an odd number of horizontal lines (525 for 60 Hz). The minimum for this    */
/* register is hex 02.                                                                                          */
/* ------------------------------------------------------------------------------------------------------------ */
/* Bit: Function:                                                                                               */
/*  - 7: - Reserved                                                                                             */
...
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_VT        6		/* 06 */ /* vertical total */ /* Vertical Characters Displayed (MCGA) */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Vertical Characters Displayed Register, */
/* Index 06:                                                                                                    */
/* ------------------------------------------------------------------------------------------------------------ */
/* This register con-tains the 8 least significant bits for the number of scan lines displayed in the vertical  */
/* scan interval. The most significant bit is the inversion of bit 6 of the Mode Control register.              */
/* ------------------------------------------------------------------------------------------------------------ */
#define VGA_CRT_OF        7		/* 07 */ /* overflow */ /* Start Vertical Sync (MCGA) */
/* ------------------------------------------------------------------------------------------------------------ */
/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Start Vertical Sync Register, Index 07: */
/* ------------------------------------------------------------------------------------------------------------ */
/* This register contains the 8 least significant bits for the vertical scan line count. It determines when the */
/* vertical sync signal becomes active. The most significant bit is the inversion of bit 6 of the Mode Control  */
/* register.                                                                                                    */
/* ------------------------------------------------------------------------------------------------------------ */
/* ------------------------- */	/* 08 */ /* Reserved */
#define VGA_CRT_MS        9		/* 09 */ /* Scan Lines per Character */
#define VGA_CRT_CS        10	/* 0A */ /* Cursor Start */
#define VGA_CRT_CE        11	/* 0B */ /* Cursor End */
#define VGA_CRT_SAH       12	/* 0C */ /* Start of Screen High */
#define VGA_CRT_SAL       13	/* 0D */ /* Start of Screen Low */
#define VGA_CRT_CLH       14	/* 0E */ /* Cursor Position High */
#define VGA_CRT_CLL       15	/* 0F */ /* Cursor Position Low */
#define VGA_CRT_VRS       16	/* 10 */ /* vertical retrace start */ /* Mode Control (MCGA) */
#define VGA_CRT_VRE       17	/* 11 */ /* vertical retrace end */ /* Interrupt Control (MCGA) */
#define VGA_CRT_VD        18	/* 12 */ /* vertical display enable end */ /* Character Generator Interface and Sync */
																  /* Polarity, or Display Sense (MCGA) */
#define VGA_CRT_OFS       19	/* 13 */ /* offset */ /* Character Font Pointer (MCGA) */
#define VGA_CRT_ULL       20	/* 14 */ /* underline location */ /* Number of Characters to Load (MCGA) */
#define VGA_CRT_MODE      23	/* 00 */ /* crt mode control */
#define VGA_CRT_LC        24	/* 00 */ /* line compare */
/* ------------------------- */	/* 20 */ /* Reserved */
...
{
	/* ------------------------------------------------------------------------------------------------------------ */
	/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Display Formats:                        */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* In alphanumeric (text) modes 0 through 3, two bytes define each char-acter on the display screen. The even   */
	/* byte accesses the character generator to create the PEL data. The odd byte defines the color of the PELs.    */
	/* Sixteen colors are available for foreground, and eight colors are available for background when blink is     */
	/* enabled (default). Blink is controlled in the CGA Mode Control register, hex 3D8.                            */
	/*                                                                                                              */
	/* The format of the two bytes is shown in the following:                                                       */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* Odd Byte:       Even Byte:                                                                                   */
	/*  - 7: Attribute: - 7: Character:                                                                             */
	/*  - 6: Attribute: - 6: Character:                                                                             */
	/*  - 5: Attribute: - 5: Character:                                                                             */
	/*  - 4: Attribute: - 4: Character:                                                                             */
	/*  - 3: Attribute: - 3: Character:                                                                             */
	/*  - 2: Attribute: - 2: Character:                                                                             */
	/*  - 1: Attribute: - 1: Character:                                                                             */
	/*  - 0: Attribute: - 0: Character:                                                                             */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* Figure 1-23. Alphanumeric Format:                                                                            */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* The following are the bit definitions of the attribute byte. Bit 7 selects a blinking character, or if       */
	/* blinking is disabled, selects palette addresses above hex 07 for the background color.                       */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* Bits:     Function:                                                                                          */
	...
	/* ------------------------------------------------------------------------------------------------------------ */
	/* There are two color sets: color set 0 and color set 1. For information about the colors selected, see "CGA   */
	/* Border Register, 3D9," later in this section under "Video Formatter Registers."                              */
	/*                                                                                                              */
	/* In modes 6 and 11, one bit defines each PEL, with the most significant bit defining the first PEL. The       */
	/* foreground color maps to the color in the CGA Border Control register if the B&W bit in the CGA Mode Control */
	/* Register is 0. If the B&W bit is 1, the foreground color maps to palette address hex 07. The background color*/
	/* always maps to address hex 00.                                                                               */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* Bit:   PEL Definition:                                                                                       */
	/*  - 7  : - C0    : First PEL                                                                                  */
	/*  - 6  : - C0    :                                                                                            */
...
{
	/* ------------------------------------------------------------------------------------------------------------ */
	/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Text Modes:                             */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* In the text modes, the character box size is 8-by-16. The character font table is loaded into the character  */
	/* generator. All 16 scan lines are programmed into the character generator.                                    */
	/* ------------------------------------------------------------------------------------------------------------ */
	unsigned val;
	...
	return (val);
	/* ------------------------------------------------------------------------------------------------------------ */
	/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Graphics Modes:                         */
	/* ------------------------------------------------------------------------------------------------------------ */
	/*In the graphics modes, the character font table is used to create the character PELs. For most graphics modes,*/
	/* the character box is an 8-by-8 character box that is double-scanned to creata an 8-by-16 char-acter, however,*/
	/* all 16 scan lines of the 8-by-16 box are are not programmable.                                               */
	/*                                                                                                              */
	/* The 640-by-480 graphics mode is the exception. It uses an 8-by-16 character box and a separate font table.   */
	/* In this mode, 30 character rows are displayed.                                                               */
	/* ------------------------------------------------------------------------------------------------------------ */
}
	...
	unsigned char *r, unsigned char *g, unsigned char *b)
{
	...
	*b = vga->reg_dac[idx + 2];
	/* ------------------------------------------------------------------------------------------------------------ */
	/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Video Storage Organization:             */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* The following is the memory mapping for text modes 0 through 3.                                              */
	/* ------------------------------------------------------------------------------------------------------------ */
	/*  - A0000: Character Generator Self-load Storage                                                              */
	/*  - A7FFF: Character Generator Self-load Storage                                                              */
	/*  -      : Not Used                                                                                           */
	...
	/* ------------------------------------------------------------------------------------------------------------ */
	/* The following is the memory mapping for graphcis modes 4 through 6. In modes 4 and 5, each byte defines four */
	/* PELs. In mode 6, each byte defines eight PELs.                                                               */
	/* ------------------------------------------------------------------------------------------------------------ */
	/*  - B0000: Not Used                                                                                           */
	/*  -      : Not Used                                                                                           */
	/*  -      : Not used                                                                                           */
	/*  - B8000: PEL Byte: Even Scan Lines                                                                          */
	/*  - B8001: PEL Byte: Even Scan Lines                                                                          */
	/*  -      : 0                                                                                                  */
	/*  -      : 0                                                                                                  */
	/*  - BA000: PEL Byte:  Odd Scan Lines                                                                          */
	/*  - BA001: PEL Byte:  Odd Scan Lines                                                                          */
	/*  -      : 0                                                                                                  */
	/*  -      : 0                                                                                                  */
	/*  - BFFFE:                                                                                                    */
	/*  - BFFFF:                                                                                                    */
	...
	/* ------------------------------------------------------------------------------------------------------------ */
	/* The following is the memory mapping for graphics modes 11 and 13. In mode 11, each byte defines eight PELs;  */
	/* in mode 13, each byte defines one PEL.                                                                       */
	/* ------------------------------------------------------------------------------------------------------------ */
	/*  - A0000: PEL Byte                                                                                           */
	/*  - A0001: PEL Byte                                                                                           */
	/*  -      : 0                                                                                                  */
...
void vga_update (vga_t *vga)
{
	int      show;
	unsigned w, h;
	w = vga_get_w (vga); /* Width  */
	h = vga_get_h (vga); /* Height */
	show = 1;
...
unsigned char vga_mem_get_uint8 (vga_t *vga, unsigned long addr)
{
	...
	case 0: /* 128K at A000 */
		/* -------------------------------------------------------------------------------------------------------- */
		/* IBM Personal System/2 Model 25/30: Quote from "Technical Reference"; Figure 1-22: Video Mode Summary:    */
		/* -------------------------------------------------------------------------------------------------------- */
		/* Video Modes:                         Analog Display:                                                     */
		/*  - Mode 0,1: 40 Column: Alphanumeric: - 40 column by 25 rows                                             */
		/*                                       -  8 -by-16 character box                                          */
		/*                                       - 320 by 400                                                       */
		/*                                       -  16 of 256K colors or 16 of 64 shades of gray (monochrome)       */
	...
	case 2: /* 32K at B000 */
		...
		/* -------------------------------------------------------------------------------------------------------- */
		/* Video Modes:                         Analog Display:                                                     */
		/*  - Mode 2,3: 80 Column: Alphanumeric: - 80 column by 25 rows                                             */
		/*                                       -  8 -by-16 character box                                          */
		/*                                       - 640 by 400                                                       */
		/*                                       - 16 of 256K colors or 16 of 64 shades of gray (monochrome)        */
		/*                                       - Display Buffer B8000                                             */
...
unsigned char vga_reg_get_uint8 (vga_t *vga, unsigned long addr)
{
	...
	/* ------------------------------------------------------------------------------------------------------------ */
	/* IBM Personal System/2 Model 25/0: Quote from "Technical Reference"; Video Memory Controller Registers:       */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* The video memory controller contains an index register and 22 data registers. Two I/O commands are required  */
	/* to write to one data reg-ister: writing the desired index value to address hex 3D4, and then writing the data*/
	/* to address hex 3D5.                                                                                          */
	/* ------------------------------------------------------------------------------------------------------------ */
	case VGA_CRT_INDEX: /* 3D4 */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* IBM Personal System/2 Model 25/0: Quote from "Technical Reference";Memory Controller Index Register, Hex 3D4:*/
	/* ------------------------------------------------------------------------------------------------------------ */
	/* This register is read/write, and points to the specific data register addressed through hex 3D5.             */
	/* ------------------------------------------------------------------------------------------------------------ */
	/* Bit: Function:                                                                                               */
	/*  - 7: - Reserved                                                                                             */
	/*  - 6: - Reserved                                                                                             */

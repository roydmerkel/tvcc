...
unsigned g386_protected_mode_op_divide_error(e8086_t *c)
{
 ...
 /* OP 60: PUSHA or PUSHAD (Real Mode) */
static
unsigned e386_real_mode_op_60(e8086_t *c)
{
	if (c->e386_operand_size_prefix == 1)
	{
		...
		unsigned long  tmp;
		tmp = e386_get_esp(c);
		if ((tmp == 0x00000001) || (tmp = 0x00000003) || (tmp = 0x00000005))
		{
			/* CPU shutting down if SP or ESP equals 1, 3,     or  5 */
			e86_reset;
		}
		if ((tmp == 0x00000007) || (tmp = 0x00000009) || (tmp = 0x00000011) || (tmp = 0x00000013) || (tmp = 0x00000015))
		{
			/* Exception 13      if SP or ESP equals 7, 9, 11, or 15 */
			e86_trap(c, 13);
			c->fs_segment = 0;
			c->gs_segment = 0;
			c->e386_address_size_prefix = 0;
		...
		g386_real_mode_push32(c, e386_get_eax(c));
		g386_real_mode_push32(c, e386_get_ecx(c));
		g386_real_mode_push32(c, e386_get_edx(c));
		g386_real_mode_push32(c, e386_get_ebx(c));
		g386_real_mode_push32(c, tmp);
		g386_real_mode_push32(c, e386_get_ebp(c));
		g386_real_mode_push32(c, e386_get_esi(c));
		g386_real_mode_push32(c, e386_get_edi(c));
	}
	else
	{
		/* 16-bit register operand specified */
		unsigned short tmp;
		tmp = e86_get_sp(c);
		if ((tmp == 0x0001) || (tmp = 0x0003) || (tmp = 0x0005))
		{
			/* CPU shutting down if SP or ESP equals 1, 3,     or  5 */
			e86_reset;
		}
		if ((tmp == 0x0007) || (tmp = 0x0009) || (tmp = 0x0011) || (tmp = 0x0013) || (tmp = 0x0015))
		{
			/* Exception 13      if SP or ESP equals 7, 9, 11, or 15 */
			e86_trap(c, 13);
			c->fs_segment = 0;
...
/* OP 60: PUSHA or PUSHAD (Virtual 8086 Mode) */
static
unsigned e386_virtual_8086_mode_op_60(e8086_t *c)
{
	if (c->e386_operand_size_prefix == 1)
	{
		...
		g386_virtual_8086_mode_push32(c, e386_get_eax(c));
		g386_virtual_8086_mode_push32(c, e386_get_ecx(c));
		g386_virtual_8086_mode_push32(c, e386_get_edx(c));
		g386_virtual_8086_mode_push32(c, e386_get_ebx(c));
		g386_virtual_8086_mode_push32(c, tmp);
		g386_virtual_8086_mode_push32(c, e386_get_ebp(c));
		g386_virtual_8086_mode_push32(c, e386_get_esi(c));
		g386_virtual_8086_mode_push32(c, e386_get_edi(c));
	}
	else
	{
		/* 16-bit register operand specified */
...
/* OP 60: PUSHA or PUSHAD (Protected Mode) */
static
unsigned e386_protected_mode_op_60(e8086_t *c)
{
	...
	{
		/* 32-bit register operand specified */
		unsigned long  tmp, new_value;
		unsigned long  ss_segment_limit;
		tmp = e386_get_esp(c);
		new_value = tmp - 16;
		ss_segment_limit = c->ss_segment_register_descriptor_limit;
		if ((tmp > ss_segment_limit) || (new_value > ss_segment_limit))
		{
			/* Stack Fault if starting or ending stack address is outside the stack segment limit */
			e86_trap(c, 12);
			c->fs_segment = 0;
			c->gs_segment = 0;
			c->e386_address_size_prefix = 1;
		...
		g386_protected_mode_push32(c, e386_get_eax(c));
		g386_protected_mode_push32(c, e386_get_ecx(c));
		g386_protected_mode_push32(c, e386_get_edx(c));
		g386_protected_mode_push32(c, e386_get_ebx(c));
		g386_protected_mode_push32(c, tmp);
		g386_protected_mode_push32(c, e386_get_ebp(c));
		g386_protected_mode_push32(c, e386_get_esi(c));
		g386_protected_mode_push32(c, e386_get_edi(c));
	}
	else
	{
		/* 16-bit register operand specified */
		unsigned short tmp, new_value;
		unsigned long  ss_segment_limit;
		tmp = e86_get_sp(c);
		new_value = tmp - 16;
		ss_segment_limit = c->ss_segment_register_descriptor_limit;
...
unsigned e386_real_mode_op_61(e8086_t *c)
{
	if (c->e386_operand_size_prefix == 1)
	{
		...
		tmp = e386_get_esp(c);
		ss_segment_limit = c->ss_segment_register_descriptor_limit;
		e386_set_edi(c, g386_real_mode_pop32(c));
		e386_set_esi(c, g386_real_mode_pop32(c));
		e386_set_ebp(c, g386_real_mode_pop32(c));
		g386_real_mode_pop32(c);
		new_value = e386_get_esp(c);
		if ((tmp > ss_segment_limit) || (new_value > ss_segment_limit))
		{
		...
		e386_set_ebx(c, g386_real_mode_pop32(c));
		e386_set_edx(c, g386_real_mode_pop32(c));
		e386_set_ecx(c, g386_real_mode_pop32(c));
		e386_set_eax(c, g386_real_mode_pop32(c));
	}
	else
	{
		/* 16-bit register operand specified */
...
/* OP 61: POPA or POPAD (Virtual 8086 Mode) */
static
unsigned e386_virtual_8086_mode_op_61(e8086_t *c)
{
	if (c->e386_operand_size_prefix == 1)
	{
		...
		tmp = e386_get_esp(c);
		ss_segment_limit = c->ss_segment_register_descriptor_limit;
		e386_set_edi(c, g386_virtual_8086_mode_pop32(c));
		e386_set_esi(c, g386_virtual_8086_mode_pop32(c));
		e386_set_ebp(c, g386_virtual_8086_mode_pop32(c));
		g386_virtual_8086_mode_pop32(c);
		new_value = e386_get_esp(c);
		if ((tmp > ss_segment_limit) || (new_value > ss_segment_limit))
		{
			/* Interrupt 13 if outside of effective address range from 0 to 0FFFFH */
		...
		e386_set_ebx(c, g386_virtual_8086_mode_pop32(c));
		e386_set_edx(c, g386_virtual_8086_mode_pop32(c));
		e386_set_ecx(c, g386_virtual_8086_mode_pop32(c));
		e386_set_eax(c, g386_virtual_8086_mode_pop32(c));
	}
	else
	{
		/* 16-bit register operand specified */
...
/* OP 61: POPA or POPAD (Protected Mode) */
static
unsigned e386_protected_mode_op_61(e8086_t *c)
{
	if (c->e386_operand_size_prefix == 1)
	{
		...
		tmp = e386_get_esp(c);
		ss_segment_limit = c->ss_segment_register_descriptor_limit;
		e386_set_edi(c, g386_protected_mode_pop_word_or_dword_register32(c));
		e386_set_esi(c, g386_protected_mode_pop_word_or_dword_register32(c));
		e386_set_ebp(c, g386_protected_mode_pop_word_or_dword_register32(c));
		g386_protected_mode_pop_word_or_dword_register32(c);
		new_value = e386_get_esp(c);
		if ((tmp > ss_segment_limit) || (new_value > ss_segment_limit))
		{
			/* Stack Fault if starting or ending stack address is outside the stack segment limit */
		...
		e386_set_ebx(c, g386_protected_mode_pop_word_or_dword_register32(c));
		e386_set_edx(c, g386_protected_mode_pop_word_or_dword_register32(c));
		e386_set_ecx(c, g386_protected_mode_pop_word_or_dword_register32(c));
		e386_set_eax(c, g386_protected_mode_pop_word_or_dword_register32(c));
	}
	else
	{
		/* 16-bit register operand specified */
	...
	if (c->cpumodel >= 0x80386) {
		...
		if ((e286_get_pe(c) == 0) && (e386_get_vm(c) == 0))
		{
			...
			if (c->e386_address_size_prefix == 1)
			{
				...
				if (c->prefix & (E86_PREFIX_REP | E86_PREFIX_REPN)) {
					while (e386_get_ecx(c) > 0) {
						e86_set_mem8(c, e386_get_es(c), e386_get_edi(c), e86_get_prt8(c, e386_get_edx(c)));
						e386_set_edi(c, e386_get_edi(c) + inc);
			...
			else
			{
				...
				unsigned long  es_segment_limit;
				inc = e86_get_df(c) ? 0xffff : 0x0001;
				source = e86_get_di(c);                                     /* Source Operand   */
				es_segment_limit = c->es_segment_register_descriptor_limit; /* ES Segment Limit */
				if (source > es_segment_limit)
				{
					/* Interrupt 13 if outside of effective address range from 0 to 0FFFFH */
		...
		else if (e386_get_vm(c) == 1)
		{
			...
			if (c->e386_address_size_prefix == 1)
			{
				/* 32-bit memory operand specified */
				unsigned long  inc;
				unsigned long  source;
				unsigned long  es_segment_limit;
				inc = e386_get_df(c) ? 0xffffffff : 0x00000001;
			...
			{
				/* 16-bit memory operand specified */
				unsigned short inc;
				unsigned short source;
				unsigned long  es_segment_limit;
				inc = e86_get_df(c) ? 0xffff : 0x0001;
...
/* OP 6D: INSW or INSD (Virtual 8086 Mode) */
/* static
...
/* OP 6D: INSW or INSD (Protected Mode) */
/* static
			...
			if (c->e386_address_size_prefix == 1)
			{
				...
				if (c->prefix & (E86_PREFIX_REP | E86_PREFIX_REPN)) {
					while (e386_get_ecx(c) > 0) {
						...
						{
							/* 32-bit register operand specified */
							e386_set_mem32(c, e386_get_es(c), e386_get_edi(c), e86_get_prt32(c, e386_get_edx(c)));
						}
						else
						{
							/* 16-bit register operand specified */
							e386_set_mem32(c, e386_get_es(c), e386_get_edi(c), e86_get_prt16(c, e386_get_edx(c)));
						}
						e386_set_edi(c, e386_get_edi(c) + inc);
						e386_set_ecx(c, e386_get_ecx(c) - 1);
						c->instructions += 1;
			...
			else
			{
				...
				if (c->prefix & (E86_PREFIX_REP | E86_PREFIX_REPN)) {
					while (e86_get_cx(c) > 0) {
						...
						{
							/* 32-bit register operand specified */
							e86_set_mem16(c, e86_get_es(c), e86_get_di(c), e86_get_prt32(c, e86_get_dx(c)));
						}
						else
						{
							/* 16-bit register operand specified */

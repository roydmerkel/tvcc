...
static pce_option_t opts[] = {
	{ '?', 0, "HELP:", NULL, "Display usage information." },
	{ 'b', 1, "BOOT:", "int", "Set default boot drive." },
	{ 'c', 1, "CONFIG:", "string", "Select configuration file: [none]" },
	{ 'd', 1, "PATH:", "string", "Add directory to default search path." },
	{ 'g', 1, "VIDEO:", "string", "Set video device." },
	{ 'i', 1, "INI-PREFIX:", "string", "Add INI string before configuration file." },
	{ 'I', 1, "INI-APPEND:", "string", "Add INI string after configuration file." },
	{ 'l', 1, "LOG:", "string", "Set log file name: [none]" },
	{ 'p', 1, "CPU:", "string", "Set CPU model." },
	{ 'q', 0, "QUIET:", NULL, "Set log file level to error: [no]" },
	{ 'r', 0, "RUN:", NULL, "Power on machine immediately: [no]" },
	{ 'R', 0, "NO-MONITOR:", NULL, "Never stop running machine: [no]" },
	{ 's', 1, "SPEED:", "int", "Set CPU speed." },
	{ 't', 1, "TERMINAL:", "string", "Set terminal device." },
	{ 'v', 0, "VERBOSE:", NULL, "Set log file level to CPU debugger: [no]" },
	{ 'V', 0, "VERSION:", NULL, "Display emulator version." },
	{  -1, 0, NULL, NULL, NULL }
};
...
{
	pce_getopt_help (
		"pce-ibmpc: The Virtual Computer Collection.",
...
{
	pce_log (MSG_MSG,
		"The Virtual Computer Collection Release A002 ''Blowfish''" PCE_VERSION_STR "\n"
		"Copyright (C) SoftMuseum.\n"
		"Portions copyright (C) Hampa Hug <hampa@hampa.ch>\n"
	);
}
...
int pce_load_config (ini_sct_t *ini, const char *fname)
{
	...
	if (ini_read (par_cfg, fname)) {
		pce_log (MSG_ERR, "ERROR: Unable to load configuration file.\n");
		return (1);
	}
...
int main (int argc, char *argv[])
{
	...
	if (nomon) {
		...
		pce_puts ("NOTE: Type 'H' to display command reference.\n");
	}

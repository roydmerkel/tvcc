...
#define PCE_IBMPS2_MODEL25_CLK0 48000000
#define PCE_IBMPS2_MODEL25_CLK1 (PCE_IBMPS2_MODEL25_CLK0 / 3)
#define PCE_IBMPS2_MODEL25_CLK2 (PCE_IBMPS2_MODEL25_CLK0 / 12)

#define PCE_IBMPC_5150 1
#define PCE_IBMPC_5160 2
#define PCE_IBMPC_M24  4
#define PCE_COMPAQ_PORTABLE 8

#define PCE_COMPAQ_PORTABLE_PLUS 1
/* #define PCE_COMPAQ_DESKPRO 2 */
#define PCE_IBMPS2_MODEL25 4

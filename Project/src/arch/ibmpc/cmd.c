...
static mon_cmd_t par_cmd[] = {
	{ "BOOT", "[drive]:", "Set default boot drive." },
	{ "C", "[cnt]:", "Set CPU clock frequency. [1]" },
	{ "GB", "[addr...]:", "Set CPU breakpoints while running." },
	{ "G", "far:", "Continue running machine until CS segment register is modified." },
	{ "G:", "", "Power on machine." },
	{ "HM:", "", "Display command reference." },
	{ "I", "[b|w] port:", "Input BYTE (8-bit) or WORD (16-bit) values into port." },
	{ "KEY", "[[+|-]key...]:", "Simulate keystrokes." },
	{ "LOG", "int l:", "List CPU interrupt log expressions." },
	{ "LOG", "int n [expr]", "Set CPU interrupt n log expression to expr." },
	{ "O", "[b|w] port val:", "Output BYTE (8-bit) or WORD (16-bit) into port." },
	{ "PQ", "[c|f|s]:", "Fill, clear, or display status of CPU prefetch queue." },
	{ "P", "[cnt]:", "Execute cnt instructions, without trace in calls [1]." },
	{ "R", "[reg val]:", "Set CPU register." },
	{ "S", "[what]:", "Display status of any of the following components: (pc|cpu|mem|pit|ppi|pic|time|uart|video|xms)." },
	{ "T", "[cnt]:", "Execute cnt instructions [1]." },
	{ "U", "[addr [cnt [mode]]]", "Disassemble CPU instructions at specified address." }
};

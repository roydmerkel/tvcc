...
unsigned      par_slack1 = 20;
unsigned      par_slack2 = 20;
...
static pce_option_t opts[] = {
	...
	{ 'a', 0, "all", NULL, "Reset the selection" },
...
void print_help (void)
{
	...
	fputs (
		...
		"  shift-index <offset>   Shift the index by offset bits\n"
		"\n"
		"parameters are:\n"
		"  pfi-clock, slack1, slack2\n"
		"\n"
		"decode types are:\n"
		"  pri, raw, gcr-raw, mfm-raw\n"
		"\n"
		"encode types are:\n"
		"  pri\n"
		"\n"
...
int pfi_parse_range (const char *str, unsigned long *v1, unsigned long *v2, int *all)
{
	*v1 = 0;
	*v2 = 0;
	*all = 0;
...
int pfi_operation (pfi_img_t **img, const char *op, int argc, char **argv)
{
	...
	if (strcmp (op, "analyse") == 0) {
		r = pfi_analyse_tracks (*img);
	}

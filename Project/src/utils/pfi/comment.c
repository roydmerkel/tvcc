...
/*****************************************************************************
 * File name:   src/utils/pfi/comment.c                                      *
...
int pfi_comment_add (pfi_img_t *img, const char *str)
{
	...
	if (pfi_img_add_comment (img, tmp, strlen (str))) {
		return (1);
	}
...
int pfi_comment_load (pfi_img_t *img, const char *fname)
{
	...
	pfi_img_set_comment (img, NULL, 0);
...
int pfi_comment_set (pfi_img_t *img, const char *str)
{
	...
	if (pfi_img_set_comment (img, tmp, strlen (str))) {
		return (1);
	}
